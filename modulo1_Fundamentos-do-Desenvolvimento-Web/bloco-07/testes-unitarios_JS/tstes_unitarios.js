...
// const expected = division(9, 9);
// //  strictEqual significa estritamente igual, usa o método === (3 iguais), tem que ter o mesmo valor e ser do mesmo tipo.
// assert.strictEqual(expected, 3, 'Nove dividido por três é igual a três');


// O método assert.strictEqual, compara o primeiro e o segundo parâmetro utilizando o operador === . Se os valores ou os tipos forem diferentes, o teste falhará e será mostrado um erro com a mensagem que está no terceiro parâmetro, se houver (o terceiro parâmetro é opcional)
